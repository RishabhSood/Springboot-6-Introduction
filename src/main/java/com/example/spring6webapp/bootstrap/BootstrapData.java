...
import com.example.spring6webapp.repositories.PublisherRepostiory;
...
public class BootstrapData implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        Publisher savedPublisher = publisherRepostiory.save(publisher);
        ...
        System.out.println("Publisher Count: " + publisherRepostiory.count());
    }
